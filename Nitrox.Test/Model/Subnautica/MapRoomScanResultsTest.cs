...
public sealed class MapRoomScanResultsTest
{
    ...
    public void EmptyLegacyResultStoreAdoptsMetadataGeneration()
    {
        ...
        MapRoomEntity room = new(new NitroxInt3(), null, null, 0, [], 0, 0, [], 0, [], null, new NitroxTransform(), 0, string.Empty, false, new NitroxId(), new NitroxTechType("BaseMapRoom"), metadata, new NitroxId(), []);
