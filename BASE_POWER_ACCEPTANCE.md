...
|---|---|---|
| Legacy save first join | Existing power does not reset; sources migrate to typed revisioned state | NOT RUN |
| Two-client idle nuclear base | Both clients show the same stable/recharging total | NOT RUN |
...
| Bioreactor fuel cycle | Fuel inventory/removal and power agree on both clients after restart | NOT RUN |
...
| Scanner Room continuous drain | Scanner operation drains shared base power once | NOT RUN |
