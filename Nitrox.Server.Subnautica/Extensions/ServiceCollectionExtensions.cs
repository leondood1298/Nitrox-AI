    ...
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddWorld()
        {
            ...
            services.AddHostedSingletonService<WorldService>()
					...
					.AddSingleton<BasePowerSourceAuthority>()
					.AddSingleton<BasePowerDiagnostics>()
                    .AddSingleton<ScannerRoomDiagnostics>()
                    .AddSingleton<MapRoomLifecycle>()
                    .AddSingleton<MapRoomCameraControlLifecycle>()
                    .AddSingleton<MapRoomCameraControlReleaseFactory>()
