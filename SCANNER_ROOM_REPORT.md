...
- Released `master` commit `a4c9ed6f` repeated the full qualification after the protected merge: build `0` errors / 42 existing warnings; full Release suite `661 passed / 8 skipped / 0 failed`; PowerShell parser/evidence tests and merge diff checks passed.
