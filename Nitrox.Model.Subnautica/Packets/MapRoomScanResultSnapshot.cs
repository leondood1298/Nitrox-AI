...
public class MapRoomScanResultSnapshot : Packet
{
    ...
    public MapRoomScanResultSnapshot(NitroxId mapRoomId, long generation, List<MapRoomScanResultRecord> results, long revision = 0, bool isServerResponse = false, bool granted = false)
    {
        MapRoomId = mapRoomId;
